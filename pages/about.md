...
{% include feature/nav-menu.html sections="About the Collection;About Bob McCoy;About the Site;About the About Page" %}
...
{% include feature/image.html objectid="quack-barb" width="50" %}
